/* AirVibe — TS013 Portable Codec (v2.1.2)
   ...
   ESM wrapper — imported by utils/airvibeDecoder.ts & utils/airvibeEncoder.ts.
   The canonical CommonJS copy lives at public/assets/AirVibe_TS013_Codec_v2.1.2.js.
*/
    ...
    try {
        ...
        if (port === 8) {
            ...
            // --- TYPE 2 & 7: OVERALL / ALARM ---
                ...
                res.data = {
                    packet_type: type,
                    status: STATUS_ID[rawStatus] || "unknown",
...
export { decodeUplink, encodeDownlink, decodeDownlink };
